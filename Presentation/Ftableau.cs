...
namespace WindowsCashFlow
{
    public partial class Ftableau : Form
    {
        ...
        private void Ftableau_Load(object sender, EventArgs e)
        {
            ...
            nomsHeaderCell.Add("Chiffre d'affaires avant impôt sur sociétés");
            nomsHeaderCell.Add("Montant impôt sur sociétés");
            nomsHeaderCell.Add("");
        ...
        private void CreerDgv(List<String> nomsHeaderCell)
        {
            ...
            for (int i = 0; i < cpt; i++)
            {
                dg_cash.Columns[i].HeaderCell.Value = "Année n°" + (i+1);
            }
